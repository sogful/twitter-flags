...
if neither work, then the firefox versions you're installing are too gated and you might need to find a workaround. you can try using the <code>/userscript/</code>!
<h5>see also:</h5>
<table>
  <tr valign="center">
    <td>
